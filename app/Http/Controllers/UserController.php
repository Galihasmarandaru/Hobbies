...
class UserController extends Controller
{
    ...
    {
        $this->middleware('auth')->except(['show']); //middleware bisa juga di web.php, di sini bisa custom yang except
    }
    /**
    ...
    public function update(Request $request, User $user)
    {
        ...
        $request->validate([
            ...
            // 'image' => 'mimes:jpeg,jpg,bmp,png,gif|dimensions:max_width=200,min_height=100'
    ...
    public function saveImages($imageInput, $user_id)
    {
        ...
        if ($image->width() > $image->height()) { // Landscape
            ...
            $image->widen(500)
                ...
                ->widen(300)->pixelate(12) // 12 pixel
            ...
            $image->heighten(500)
                ->save(public_path() . "/img/users/" . $user_id . "_large.jpg")
                ->heighten(300)->pixelate(12) // 12 pixel
                ->save(public_path() . "/img/users/" . $user_id . "_pixelated.jpg");
